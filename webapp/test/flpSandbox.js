		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriAppMasterDetail",
									"targetURL": "#FioriAppMasterDetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FioriAppMasterDetail-display": {
								"semanticObject": "FioriAppMasterDetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.fiori.Master-detail",
									"url": sap.ui.require.toUrl("acc/fiori/Master-detail")
								}
							}
						}
					}
